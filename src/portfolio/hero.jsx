...
export default function hero() {
  ...
  return (
    <div className='lg:p-8'>
        <div className='flex flex-auto flex-wrap items-center justify-around bg-orange-700'>
            <div className='text-zinc-800 box-content'>
                <h4 className='text-xl font-bold m-2 tracking-widest'>Front-End Developer</h4>
                <h1 className='text-5xl lg:text-6xl font-semibold m-2 mb-12 tracking-wide'>Rich Marmolejo</h1>
